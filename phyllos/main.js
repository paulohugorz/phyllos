...
if (cursor) {
  ...
  document.querySelectorAll('a, button, .product-card, .cat-card, .size, .material-card, .collection-feature, .concept-card, .research-item, .bp-flow a, .bp-director-grid article, .trace-choice, .trace-material, .trace-check, .trace-upload-zone').forEach(el => {
