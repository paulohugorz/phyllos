...
O produto é a prova física da marca. A PHYLLOS deve começar estreita e excelente: calça primeiro, depois camisa, depois blazer.

## Objetivos

- Desenvolver o MVP de produto.
- Priorizar a primeira coleção começando por calça.
...
- Definir arquitetura de coleção: calça, depois camisa, depois blazer.
- Priorizar a primeira família PH001-PH005: Calça Performance Alfaiataria, Calça Dia a Dia, Camisa Performance, Vestido Versátil e Saia Conforto.
