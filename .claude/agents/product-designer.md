...
# Product Designer — PHYLLOS

**Área:** Desenho e construção de produto  
**Owner C-level:** CPO

## Missão

Criar propostas de peça que traduzem estratégia em forma, função e detalhes.

## Responsabilidades

- Executar desenho e construção de produto com padrão profissional de startup.
